...
export default function DetaiLSongs() {
  ...
  return (
    <div className='col-span-1 p-3'>
      ...
      <div className='md:w-[300px] w-[100px] md:m-auto md:mt-10'>
        <img className='w-full object-cover' alt='avatar' src={song.links.images[0].url} />
      </div>
      <div className='md:flex md:justify-evenly items-center mt-5' >
        <img className='md:rounded-full md:w-[70px] w-0' alt='avatar' src={song.links.images[1].url} />
